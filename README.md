...
## Stratégie
- L'objectif principal étant d'attirer le recruteur, j'ai décidé de choisir une méthode de desktop-first (designer l'architecture du site pour l'ordinateur en 1er). Le recruteur sera généralement assis à une table avec son ordinateur.
...
- Une page gallerie contiendra deux onglets sous le menu principal pour soit voir les photos, soit les videos. L'onglet photos serait sélectionné par défaut. A gauche on retrouverait les noms de concerts pour afficher les photos ou video correspondant à ces périodes.
- La page de contact proposera un formulaire à choix multiples. Il sera possible de demander un envoi d'ep directement via le formulaire ou encore de demander une réservation au groupe.
